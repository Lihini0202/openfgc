 ...
 */
/*
 * Deliberately unmapped in this deployment. This servlet reads the Identity Server's consent management v2 API,
 * whereas the portal's consent records live in the Consent Server -
 * MeConsentsServlet and ConsentApiProxyServlet serve these paths from there
 * instead. Retained for deployments where the Identity Server owns consent.
 */

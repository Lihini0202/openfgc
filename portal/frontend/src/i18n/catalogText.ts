 ...
 * wording cannot live in `common.ts` the way our own UI text does. Instead each
 * language carries a `catalog.ts` keyed by the item's `name`, and this hook
 ...
 * back to it. `en/catalog.ts` exists only as the work list translators copy.
 */

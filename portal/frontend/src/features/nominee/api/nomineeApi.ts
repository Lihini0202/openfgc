...
export async function fetchActingConsents(
  ...
  return apiRequest<ConsentSearchResponse>('/acting/consents', {
    method: 'GET',
    query: {
...
export async function fetchActingConsentByID(consentID: string): Promise<ConsentDetailAPI> {
  return apiRequest<ConsentDetailAPI>(`/acting/consents/${encodeURIComponent(consentID)}`, {
    method: 'GET',
  })
}

export async function revokeActingConsent(consentID: string): Promise<void> {
  return apiRequestNoContent(`/acting/consents/${encodeURIComponent(consentID)}/revoke`, {
    method: 'POST',
  })
}
...
export async function approveActingConsent(
  ...
  return apiRequestNoContent(`/acting/consents/${encodeURIComponent(consentID)}/approve`, {
    method: 'POST',
    headers: {

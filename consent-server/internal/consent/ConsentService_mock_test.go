...
// ExpireConsent provides a mock function with given fields: ctx, consent, orgID
func (_m *MockConsentService) ExpireConsent(ctx context.Context, consent *model.Consent, orgID string) error {
	ret := _m.Called(ctx, consent, orgID)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.Consent, string) error); ok {
		r0 = rf(ctx, consent, orgID)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockConsentService) GetExpiredConsents(ctx context.Context, nowMs int64, expirableStatuses []string) ([]model.Consent, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, []string) ([]model.Consent, error)); ok {
